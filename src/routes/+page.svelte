...
<style>
  ...
  .content { max-width: 1600px; margin: 0 auto; padding: 0 clamp(1rem, 4vw, 2rem); width: 100%; }
  ...
  .filter-btn { min-height: 40px; padding: 0 1.15rem; border-radius: 8px; border: 1.5px solid #b0d0be; background: #fff; color: #5a8a6a; font-family: 'Sarabun', sans-serif; font-size: .88rem; font-weight: 700; cursor: pointer; transition: all .18s; white-space: nowrap; }
  ...
  .grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: clamp(1rem, 1.8vw, 1.35rem); justify-items: stretch; align-items: stretch; width: 100%; padding-bottom: clamp(3rem, 8vw, 5rem); }
  .card { width: 100%; min-height: 100%; background: #fff; border-radius: 18px; overflow: hidden; border: 1px solid #d0e8d8; box-shadow: 0 1px 3px rgba(10,34,24,.06), 0 6px 18px rgba(10,34,24,.10); display: flex; flex-direction: column; transition: transform .28s cubic-bezier(.34,1.4,.64,1), box-shadow .28s; }
  .card:hover { transform: translateY(-5px); box-shadow: 0 8px 32px rgba(10,34,24,.16), 0 2px 8px rgba(10,34,24,.08); }
  .card-banner { position: relative; height: 160px; overflow: hidden; background: #133526; }
