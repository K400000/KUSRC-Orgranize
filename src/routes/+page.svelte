...
<style>
  ...
  .content { max-width: 1440px; margin: 0 auto; padding: 0 clamp(1rem, 4vw, 2rem); width: 100%; }
  ...
  .filter-btn { height: 36px; padding: 0 1.1rem; border-radius: 8px; border: 1.5px solid #b0d0be; background: #fff; color: #5a8a6a; font-family: 'Sarabun', sans-serif; font-size: .82rem; font-weight: 600; cursor: pointer; transition: all .18s; white-space: nowrap; }
  ...
  .grid { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); gap: clamp(1rem, 2.5vw, 1.5rem); justify-items: stretch; align-items: stretch; width: 100%; padding-bottom: clamp(3rem, 8vw, 5rem); }
  .card { width: 100%; background: #fff; border-radius: 16px; overflow: hidden; border: 1px solid #d0e8d8; box-shadow: 0 1px 3px rgba(10,34,24,.06), 0 4px 16px rgba(10,34,24,.08); display: flex; flex-direction: column; transition: transform .28s cubic-bezier(.34,1.4,.64,1), box-shadow .28s; border-radius: 16px; }
